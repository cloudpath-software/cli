...
export default function isValidEventName(eventName: string, config: any) {
...
const containsSeparators = function (eventName: string) {
...
const formattingWarning = function (eventName: string, errorMsg = undefined) {
    log('-----------------------------');
    log('Tracking Error:');
