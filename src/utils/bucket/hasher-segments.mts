...
export const fileNormalizerCtor = ({ assetType, normalizer: normalizeFunction }: any) => map((fileObj) => {
...
export const manifestCollectorCtor = (filesObj: any, shaMap: any, { assetType, statusCb }: any) => {
    if (!statusCb || !assetType)
        throw new Error('Missing required options');
    return flushWriteStream.obj((fileObj, _, cb: any) => {
...
export const fileFilterCtor = objFilterCtor((fileObj: any) => fileObj.type === 'file');