...
import {deployFileNormalizer} from "../deploy/files.mjs";
export const uploadNodes = async (
    api: any,
    bucketId: string,
    dir: any,
    {
    ...
    // }
    // else {
    //     deployParams = { ...deployParams, deploy_id: folderIdOpt };
    ...
    //     phase: 'stop',
    // });
    const uploadList = getUploadList(files, filesShaMap);

    console.log("uploadList", uploadList)

    await uploadFiles(api, bucketId, uploadList, { concurrentUpload, statusCb, maxRetry }, folderIdOpt);
    // statusCb({
