...
const normalizeConfiguredVersion = (version: string) => version.startsWith(NVM_FLAG_PREFIX) ? version.slice(NVM_FLAG_PREFIX.length) : version;
export const detectNodeVersion = async ({ baseDirectory, env }: any) => {
    try {
